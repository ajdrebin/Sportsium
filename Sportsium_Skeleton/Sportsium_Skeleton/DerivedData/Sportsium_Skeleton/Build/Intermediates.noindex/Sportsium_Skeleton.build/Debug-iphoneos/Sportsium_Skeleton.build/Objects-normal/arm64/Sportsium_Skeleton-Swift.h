...
- (void)tappedTeamWithSender:(id _Nonnull)sender;
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified game1;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified game2;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified game3;
- (void)viewDidLoad;
- (void)buttonActionWithSender:(UIButton * _Null_unspecified)sender;
- (void)prepareForSegue:(UIStoryboardSegue * _Nonnull)segue sender:(id _Nullable)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC18Sportsium_Skeleton22IdentifyViewController")
@interface IdentifyViewController : UIViewController <AVCaptureVideoDataOutputSampleBufferDelegate>
...
- (void)viewDidLoad;
- (IBAction)didTapFBWithSender:(UIButton * _Nonnull)sender;
- (IBAction)didTapTTWithSender:(UIButton * _Nonnull)sender;
- (IBAction)didTapIGWithSender:(UIButton * _Nonnull)sender;
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified scoringLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified bulletLabel;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
